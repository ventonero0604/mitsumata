...
document.addEventListener('DOMContentLoaded', () => {
  if ($('main').hasClass('Top')) {
    const scene1 = document.getElementById('top_lead_scene_1');
    const scene2 = document.getElementById('top_lead_scene_2');
    const scene3 = document.getElementById('top_lead_scene_3');
    const scene4 = document.getElementById('top_lead_scene_4');

    ScrollTrigger.create({
      trigger: '#top_lead_que1',
      start: 'top 80%',
      onEnter: () => {
