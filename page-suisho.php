    ...
    <div class="Info_wrapper Info_wrapper-suisho">
      ...
      <nav class="Info_menu">
        ...
        <ul class="Info_menu_list">
          ...
          <li><a href="#belongings">持参していただきたいもの</a></li>
          <!--<li><a href="#calendar">カレンダー</a></li>-->
          <li><a href="#charges">各種料金</a></li>
        </ul>
      ...
      <section class="Info_contents">
        ...
        <div class="Info_text">
          <p>開設時期</p>
          <!--<p>7月10日(月)～9月30日(土)の宿泊まで</p>-->
		<p>2024年3月上旬にお知らせ予定</p>
        </div>
        <div class="Info_text">
          <p>定員</p>
          <p>35名</p>
        ...
        <div class="Info_text_wrapper">
          <div class="Info_text">
            <p>予約の受付</p>
            <!--<p><a href="https://reserva.be/kurobegenryu2024/reserve?mode=htl&evt_no=f4eJwzNDezMAMAAx4BDQ&room_num=1&people=1.0.0.0" target="_blank">WEB予約フォーム</a> 24時間受付（<a href="https://id-sso.reserva.be/login/consumer">Reserva会員へ登録</a>のうえ、ご予約ください。）</p>-->
			<p>2024年4月ごろ開始予定</p>
          </div>
          <div class="Info_text">
            <p>予約専用電話</p>
            <p>
              <!--予約専用番号 <a href="tel:070-1183-7080">070-1183-7080</a><br /><small>受付時間: 7:00～16:00</small>-->
			2024年7月にお知らせ予定
            </p>
          </div>
		　<div class="Info_text">
          ...
          <div class="Info_text">
            <p>団体予約（7-10名様）</p>
            <p>
              <!--Ｅmailまたは予約専用電話での受付（FAX使えません）<br>
              ▪予約専用番号 <a href="tel:070-1183-7080">070-1183-7080</a><br>
        ...
        <div class="Info_text_wrapper">
          <div class="Info_text">
            ...
            <div>
			  <p style="text-align: center; margin-bottom: 50px;">3月上旬にお知らせ予定</p>
              <!--<p>
              ...
              <div class="col2 mt-6">
                <span>個人</span>
                <span>宿泊日の4日前～キャンセル料　3,000円/人</span>
              </div>
              <div class="col3 mt-6">
                <p>団体</p>
                <div>
        ...
        <div class="Info_text_wrapper">
          ...
          <div class="Info_text">
            <p>グループ割</p>
            <p>500円引き(水晶小屋・雲ノ平山荘)</p>
          </div>
          <div class="Info_text">
            <p>ユース割</p>
            <p>
              お布団お食事なしの子ども：無料<br />
              小学生以下：2,000円(素泊まり料金)<br />
              18歳以下：4,000円(素泊まり料金)<br />
              24歳以下：6,000円（素泊まり料金）
            </p>
          </div>-->
        </div>
        ...
        <h3 class="ContentsTitle ContentsTitle-center ContentsTitle-small" id="charges">各種料金<span>VARIOUS
            CHARGES</span></h3>
        <div class="Info_text_wrapper Info_text_wrapper-nb">
		  <p style="text-align: center; margin-bottom: 50px;">3月上旬にお知らせ予定</p>
          <!--<div class="Info_text">
            <p class="sp:mb-3">朝食<br class="pc">
            </p>
            <p>
              岩魚定食<br />
              1,400円
          ...
          <div class="Info_text">
            <p class="sp:mb-3">夕食</p>
            <p>
              カレーライス（おかわり自由）、お味噌汁、デザート<br />
              2,600円
            </p>
          </div>
          <div class="Info_text">
            <p class="sp:mb-3">飲料水</p>
            <p>
              雨水だけで営業しており、お分けできる量を制限させて頂いております。ご了承ください。販売の要点に関しましては下記の表をご参照ください。<br />
              ジビエもみじ丼、カレーライスなど、その他メニューもご用意します。 (15:00オーダーストップ)<br />
              <img class="pc" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/suisho/img_water_price_table.svg" alt="料金表" style="margin: 20px 0 20px;">
              <img class="sp w-full" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/img/suisho/img_water_price_table_sp.svg" alt="料金表" style="margin: 20px 0 20px;">
              <span>※</span>ろ過済み天水に関しては、水かお湯お茶をお選び頂くようになります。<br>
              <span>※</span>計り売りミネラルウォーターに関しては、市販品の専用タンクから、お持ち頂いている水筒にお入れするようになります。また、渇水時には制限させて頂く場合があります。
            </p>
          </div>
          <div class="Info_text">
            <p class="sp:mb-3">売店</p>
            <p>
              スポーツドリンク、ジュース、ビール、アルコール類、菓子、パン
            </p>
          </div>
          <div class="Info_text">
            <p class="sp:mb-3">グッズ</p>
            <p>
              水晶小屋オリジナルグッツ、Ｔシャツ、手ぬぐい、バッチ、絵葉書など
            </p>
          </div>
          <div class="Info_text">
            <p class="sp:mb-3">トイレ</p>
            <p>
              通過のみの方のご利用はトイレ使用料として200円をお願いしています。
            </p>
          </div>-->
        </div>
      </section>
